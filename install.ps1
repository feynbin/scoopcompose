...
function Install-Scoop {
    ...
    if ($downloadZipsRequired) {
        ...
        Copy-Item "$scoopMainUnzipTempDir\scoop-*\*" $SCOOP_MAIN_BUCKET_DIR -Recurse -Force
...
$SCOOP_PACKAGE_REPO = 'https://www.gitlink.org.cn/api/feynbin/scoop/archive/proxy.zip'
